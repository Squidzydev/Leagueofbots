...
async def changelog(ctx):
    await ctx.message.delete()
    embed = discord.Embed(title='Изменения - 1.12', description='$Добавлена команда: !live - помотреть матч призывателя \n$Теперь бота можно добавить к вам в дискорд канал - https://goo.su/leaguebot', color=0xf5f5f5)
